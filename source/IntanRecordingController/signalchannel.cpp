...
QDataStream& operator<<(QDataStream &outStream, const SignalChannel &a)
{
    ...
    // Oops, we forgot to save commandStream here!  Fixed this (mostly) in SignalGroup >> method.
...
QDataStream& operator>>(QDataStream &inStream, SignalChannel &a)
{
    ...
    inStream >> tempQint16;
    // Oops, we forgot to save commandStream!  Fixed this (mostly) in SignalGroup >> method.
